...
tf.app.flags.DEFINE_integer("wordembed_size", 27, "Size of wordembedding (<= 200).")
...
# 1705 pra n esquecer
tf.app.flags.DEFINE_integer("max_sent_length", 27, "Maximum sentence length (word per sent.)")

tf.app.flags.DEFINE_integer("sentembed_size", 27, "Size of sentence embedding.")
...
tf.app.flags.DEFINE_integer("max_filter_length", 3, "Maximum filter length.")
